...
function Hero({ setPage }) {
  return (
    <div className=" bg-[#2f3340] h-[80vh] w-[80vw] lg:w-[37vw] rounded-3xl shadow-xl flex flex-col items-center p-5">
      ...
      <h1 className=" text-center text-7xl lg:text-8xl tracking-wide lg:tracking-normal mt-10 font-bold bg-gradient-to-tr from-[#7A61DA] to-[#ff7a7a] bg-clip-text text-transparent">
